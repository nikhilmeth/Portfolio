window.NikDirectory = {
    ...
    footer: [
        {
            'id': 'f1',
            'href': 'https://github.com/nikhilmeth',
            'icon': 'fa fa-3 fa-github footerFonts'
        },
        {
            'id': 'f2',
            'href': 'https://www.facebook.com/nikhil.methuku',
            'icon': 'fa fa-facebook-square footerFonts'
        },
        {
            'id': 'f3',
            'href': 'https://twitter.com/nikhilmeth',
            'icon': 'fa fa-twitter-square footerFonts'
        },
        {
            'id': 'f4',
            'href': 'https://www.linkedin.com/in/nikhilesh-methuku',
            'icon': 'fa fa-linkedin-square footerFonts'
        },
        {
            'id': 'f5',
